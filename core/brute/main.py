...
if main==1:
	os.system("bash core/brute/core/tools/instagram/instagram.sh")

if main==2:
	os.system("python core/brute/core/tools/fb.py")

if main==3:
	os.system("python core/brute/core/tools/gmail.py")

if main==4:
	os.system("python core/brute/core/tools/twitter.py")

if main==5:
	os.system("python core/brute/core/tools/netflix.py")

if main==6:
	os.system("python core/brute/core/tools/zip.py")
